...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает нанесённый урон противнику,зависящий от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает блокированый урон противнику,зависящий от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет спец. умение, зависящие от класса."""
    if char_class == 'warrior':
